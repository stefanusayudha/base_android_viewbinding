...
import com.iddevops.common.databinding.FragmentSampleBinding
...
class SampleFragment : Fragment() {
    ...
    private fun displayState(state: RequestState<List<com.iddevops.common.domain.model.ShoesModel>>) {
